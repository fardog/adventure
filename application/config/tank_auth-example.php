...
|--------------------------------------------------------------------------
*/
$config['website_name'] = ''; /** ADVENTURE_REQUIRED **/
$config['webmaster_email'] = ''; /** ADVENTURE_REQUIRED **/
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = ''; /** ADVENTURE_REQUIRED **/
...
$config['recaptcha_public_key'] = ''; /** ADVENTURE_REQUIRED **/
$config['recaptcha_private_key'] = ''; /** ADVENTURE_REQUIRED **/
